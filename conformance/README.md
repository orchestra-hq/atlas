...
This vLLM run on a capable GPU model — with `CONF_CLAUDE_CODE_SMOKE=1` enabling the real Claude Code cell — is the full-matrix acceptance tier that gates M0 "done" (see [open-questions.md](../docs/open-questions.md)).
