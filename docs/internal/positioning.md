...
| 6   | **~100-line Terraform**                 | Your whole AWS deployment is ~100 lines, because the product absorbs the hard parts. The reference module _is_ the ad.                                                                                                                                | `examples/aws-terraform/` kept under the line-count bar                                         | Planned (M2)                                     |
