...
This work is scoped as a new **M0.5 "Release & prove"** milestone (see [roadmap.md](../../roadmap.md)); a green GPU acceptance run is what flipped M0 to done — achieved 2026-06-25 ([m0-acceptance.md](../m0-acceptance.md)).
